...
void cstm_pall(stack_t **head, unsigned int number);
...
void cus_nop(stack_t **head, unsigned int counter);
...
void custom_stack(stack_t **stack_head, unsigned int line_num);
